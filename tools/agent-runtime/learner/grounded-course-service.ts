...
function difficultyProfile(level: TeachingDifficultyLevel): DifficultyProfile {
  ...
  switch (level) {
    ...
    case "upper_undergraduate_or_graduate":
      return {
        ...common,
        prerequisites: ["大学高年级/研究生课程：默认具备相关先修概念和阅读技术资料的能力", "能参与课堂讨论，并完成课后作业式迁移任务"],
        objective: "使用先修概念、正式术语、课堂讨论和课后作业式迁移任务深化理解",
        openingFrame: "大学高年级/研究生课程阶段需要把资料问题放进先修概念框架。",
        intuitionFrame: "直觉模型之后要引入正式术语，并说明它与先修概念的关系。",
        structureFrame: "结构图突出先修概念、正式术语、机制链、讨论问题和作业任务。",
        actionPrompt: "课堂讨论提示：选择一个先修概念，说明它如何支撑当前机制；课后作业要迁移到新资料。",
        claimFrame: "判断时要检查正式术语、来源证据、适用边界和讨论价值。",
        assessmentFrame: "大学高年级/研究生课程检查重在能否展开课堂讨论并完成课后作业式迁移。",
        misconceptionFrame: "高阶课程常见误区是会讲术语，但不能说明适用边界。",
        misconceptionCorrection: "大学高年级/研究生课程要把正式术语、证据和适用边界一起检查。",
        summaryLine: "大学高年级/研究生课程记忆法：先修概念、正式术语、机制链、课堂讨论、课后作业。",
        protocolFrame: "协议会把资料组织成先修概念、正式术语、机制链、讨论题和课后作业。",
        practiceFrame: "把这个锚点改写成一个课堂讨论问题，并补一个课后作业式迁移场景。",
        transferPrompt: "把同一套高阶课程方法迁移到另一份技术资料：先列先修概念，再使用正式术语解释机制，最后设计一个课堂讨论题和课后作业。",
        transferMentalModel: "用先修概念承接正式术语，再通过讨论和作业检验迁移能力。",
        visualKeyElements: ["先修概念", "正式术语", "课堂讨论", "课后作业"],
        protocol: "1. 标注先修概念\n2. 引入正式术语\n3. 连接来源证据\n4. 设计课堂讨论题\n5. 完成课后作业式迁移",
        pathAction: "选择先看先修概念、机制链还是讨论题",
        pathPurpose: "训练学习者把来源材料组织成大学高年级/研究生课程可讨论、可作业化的结构。",
        primaryPathLabel: "先看先修概念",
        primaryPathTitle: "适合高阶课程起步",
        primaryPathFeedback: "先修概念能帮助正式术语落地，避免把课程写成泛泛科普。",
        secondaryPathLabel: "先看课堂讨论",
        secondaryPathTitle: "适合研究生课堂",
        secondaryPathFeedback: "课堂讨论能暴露机制边界和迁移难点。",
        claimAction: "选择一个解释是否达到高阶课程要求",
        claimObservation: "看到解释是否同时连接先修概念、正式术语、来源证据和适用边界。",
        claimPurpose: "训练学习者把资料转成可讨论、可作业化的高阶课程内容。",
        groundedClaimFeedback: "这个选择更稳，因为它用正式术语连接了先修概念、来源证据和适用边界。",
        looseClaimFeedback: "只有结论不够。高阶课程需要能支撑课堂讨论和课后作业。",
        ...
        quizIncorrectFeedback: "不对。复述原文不能证明你能讨论边界或完成迁移。",
        misconceptionPrompt: "高阶课程里最常见的理解误区是什么？",
        misconceptionCorrectFeedback: "正确。摘要式理解无法支撑正式术语、讨论和作业迁移。",
        misconceptionIncorrectFeedback: "不对。先找来源和结构是进入高阶讨论的基础。",
        transferAssessmentPrompt: "如果换成一份研究生课程资料，你会先检查哪三类信息？",
        transferOptions: ["先修概念、正式术语、课后作业迁移", "标题、作者、页数"],
        transferCorrectAnswer: "先修概念、正式术语、课后作业迁移",
        transferCorrectFeedback: "正确。高阶课程要能从先修概念走向正式术语和迁移作业。",
