...
If `learning_agent.calibrate_learning_course` returns `revision_required`, Codex should revise the targeted pages from the calibration brief and call `learning_agent.publish_learning_course` again before returning the preview.
